...
while goOn == True:
    print("You don't know why you were taken here")
    time.sleep(3)
    print("Four days, no food")
    time.sleep(3)
    print("Water droplets from the rock face behind you have barely satisfied your thirst")
    time.sleep(3)
    print("A rusted, metal lattice surrounds you, comprising the remaining three sides of your prison")
    time.sleep(5)
    print("You are sat down. Your back rests against the damp rock. Your eyes are closed")
    print("")
    print("")
    print("")
    print("")
    ...
    if choice == 'sword' or 'unsheath sword':
        ...
        print("The feel the weight of the sword in your hand. Your courage is bolstered.")
        time.sleep(2)
